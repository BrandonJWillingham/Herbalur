          ...
          orders.map((order) => (
            ...
            >
              ...
              <div className="mt-6 border-t border-[#ece8e1] pt-5">
                ...
                {!order.shipping ? (
                  <p className="mt-2 text-sm text-[#68645e]">
                    No shipping label has been created yet.
                  </p>
                ) : (
                  <div className="mt-3 space-y-2 text-sm text-[#5d5a55]">
                    ...
                    {order.shipping.trackingUrl && (
                      <a
                        ...
                        className="inline-block pt-1 text-[#26432c] underline underline-offset-4"
                      >
                        Track shipment
                      </a>
                    )}
              ...
              {/* Print buttons */}
              <div className="mt-6 flex flex-wrap gap-3 border-t border-[#ece8e1] pt-5">
                {/* Packing slip */}
                <Link
                  href={`/admin/orders/${order.id}/print`}
                  target="_blank"
                  className="rounded-lg border border-[#26432c] px-4 py-2 text-sm font-medium text-[#26432c] transition hover:bg-[#f3f6f3]"
                >
                  Print order
                </Link>
                ...
                {order.shipping?.labelUrl && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="rounded-lg bg-[#26432c] px-4 py-2 text-sm font-medium text-white transition hover:bg-[#1d3522]"
                  >
